...
export class DashOrders extends Component {
    render() {
        return (
                        ...
                        <div class="col-md-7 mr-auto text-center">
                            <div class="buttons-tabs-centered">
                                <ul id="buttonTabs" class="nav nav-tabs nav-tabs-center">
                                    ...
                                    <li class="active"><a href="#tab-c3" data-toggle="tab">Pedidos</a></li>
                                </ul>
                                <div id="myTabContent" class="tab-content">
                                    ...
                                    <div class="tab-pane fade active in" id="tab-c3">
                                        <MyOrders/>
                                    </div>
                                </div>
                            </div>
...
export default connect(mapStateToProps, null)(DashOrders);
